...
export const skillActionPatternT = enumT(
  'SkillActionPattern',
  SkillActionPattern,
);
...
export interface ISkill extends IIdentifiable {
  ...
  generatedElements: Record<Element, number>; // elements generated by the skill
  consumedElements: Record<Element, number>; // elements consumed by the skill
}
